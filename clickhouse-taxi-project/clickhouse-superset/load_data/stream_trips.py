...
# Получаем минимальное время, чтобы сдвигать шкалу
    ...
    for row in reader:
        try:
            ...
            if len(batch) >= batch_size:
                ...
                print(f"✅ Добавлено {len(batch)} строк (всего: {inserted_total})")
                batch.clear()
