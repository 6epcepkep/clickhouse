...
![Дашборд "Тяжелая" аналитика такси в Clickhouse"Тяжелая" аналитика такси в Clickhouse](img/heavy_data.png)
![Дашборд "Живая" аналитика такси в Clickhouse](img/streaming_update_graph.gif)


## 📎 Автор

Antonius — Fullstack разработчик (2025)